...
2. Building a **vision world model dataset** (with evaluation metrics) from ROS 1 bag files.
...
- **ROSCon DE & FR 2025** – *Bagzel: Reproducible Data Workflows for Robotics* 
    [Slides / Recording](https://roscon.ros.org/de/2025/)
...
```bibtex
@misc{bagzel,
  author       = {Pohl, Leon and Beer, Lukas and Sebastian, George and Backhaus, Anton and Maehlisch, Mirko},
  title        = {Bagzel: Reproducible Dataset Construction from ROS 1 and ROS 2 Bag Logs with Bazel},
  year         = {2025},
